 ...
 <div class="intro">
  <div class="wrapContent">
   <div class="colDx">
    ...
    <p>&Egrave; così possibile organizzare un percorso di visita personalizzato in questa porzione del Valdarno a partire dalla <a href="mappa.php" title="Accedi alla mappa">mappa</a> con accesso tematico o effettuando una ricerca tra le voci del <a href="poiList.php" title="Accedi alla lista completa dei punti di interesse">database</a>.</p>
   </div>
  </div>
 </div>
 ...
 <div id="mainContent" class="wrapContent">
  <div id="mainContentWrap">
   ...
   <section>
    ...
    <a href="http://www.valdarnomusei.it/htm.htm" target="_blank" title="[link esterno] scopri di più sul progetto" class="linkSez linkSezInfo">accedi <i class=" fa fa-arrow-right"></i></a>
   </section>
  </div>
  <div id="nav">
   <aside>
