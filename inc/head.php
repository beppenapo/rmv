<nav>
 <ul>
  ...
  <li class="img"><a href="#" id="enLang" class="mainLink tooltip"></a></li>
 </ul>
</nav>

<div id="wrapHead">
 <img src="img/logoBanner.png" id="logo" alt="logo rete museale Valdarno" title="Logo della rete museale del Valdarno" />
 <h1>VALDARNO <span lang="it">MUSEI</span></h1>
</div>
